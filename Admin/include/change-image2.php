...
//2nd
$oldquiz_ques="../img/quiz"."/".$oldquiz_ques;
...
move_uploaded_file($_FILES["quiz_ques"]["tmp_name"],"../img/quiz/".$imgnewquiz_ques);
...
<input type="hidden" name="oldpic" value="<?php  echo $row['quizquestion'];?>">
	<div class="form-group">
<img src="../img/quiz/<?php  echo $row['quizquestion'];?>" width="120" height="120">
		</div>

         <div class="form-group">
        	<input type="file" class="form-control" name="quiz_ques"  required="true">
