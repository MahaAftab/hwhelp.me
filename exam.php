...
<!-- End Header -->
  ...
  <?php
    ...
    $sql = "SELECT * FROM pastexam WHERE courseid = '$course_id'";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $url = "homework.php?examid=" . $examid;
        ?>
          <div class="chapter" style="margin-top: 0;"><td> <a href="<?php echo $url; ?>"><?php echo $examtittle; ?></a></td><i class="bi bi-cloud-arrow-down-fill" style="color: #000000; float: right; font-size: x-large; text-align: end; " ></i></div>
